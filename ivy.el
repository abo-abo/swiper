...
The alist KEY is either a collection function or a t to match
previously unmatched collection functions.

The alist VAL is a sorting function with the signature
`ivy--prefix-sort'.")
...
When matching candidates exceed this limit, then no sorting is
done.")
