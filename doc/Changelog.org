...
Fix overlay intracting with org-mode src blocks. See #1732.
...
See #1488, #1547, #1016, 1520, #1808, #1825.
...
*** counsel-grep
Reject fileless buffers. See #1343
...
Repace obsolte =isearch-lazy-highlight-face=. See #1591.

Highlight multiple regexps correctly.
See #654, #1550, #1551, #1587, #1600.
...
*** docs
Fixed typos. See #1405, #1412, #1448, #1477, #1483, #1519, #1521,
#1535, #1539, #1540, #1575, #1602, #1612, #1620, #1624, #1625, #1627,
#1629, #1630, #1672, #1675, #1677, #1678, #1682, #1684, #1700, #1710,
#1715, #1717, #1738, #1804, #1816, 1794, #1817, #1828, #1849.
...
*** ivy--regex-fuzzy
Regexp-quote chars to improe performance for searches like
".env.foo". See #1435.
...
Rmove 2nd prompt colon. See #1768.
...
Remove virtual buffers from =recentf-list=. See #1888.
...
=ivy-count-format= to add/remove candidate count. See #1350.
...
See #1581, #1850, #1856, #1859, #1861

New var =ivy-pulse-delay=. See #1859.

=ivy-initial-inputs-alist= entries can be functons. See #1867, #1868.
...
before completion. See #1356, #1367.

New var =counsel-yank-pop-preselect-last=: customize whether preselect
the last kill by default. See #1371, #1373, #1374.
...
Show also hidden destop files with prefix arg.
...
*** counsel-dired-jump
New var =counsel-dired-jump-args=. See #1889.
...
#702, #1389.
*** counsel-wmctrl
Select a destop window with completion.
*** counsel-org-entity
