...
LOAD = -l colir.el -l ivy-overlay.el -l ivy.el -l swiper.el -l counsel.el -l ivy-hint-display.el ivy-hint-lv.el
RM ?= rm -f
...
compile:
	$(emacs) -batch -L . -f batch-byte-compile colir.el ivy-overlay.el ivy.el swiper.el counsel.el ivy-hint-display.el ivy-hint-lv.el
