...
similar to other completion schemes such as `icomplete-mode`, Ivy aims
...
generic Ivy completion for file and buffer names. 
...
### Manual
The manual is available at [HTML](http://oremacs.com/swiper/). 
