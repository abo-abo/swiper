...
(add-to-list 'load-path "~/Dropbox/source/site-lisp/git/plain-org-wiki")
...
(add-to-list 'load-path "~/.emacs.d/straight/build/htmlize")
(setq plain-org-wiki-directory "~/Dropbox/org/wiki/")
